...
leg.mass <- musc.dat$Live_mass..g. * musc.dat$Muscle.mass.Body.mass.ratio / 1000 #calculate wet muscle mass and convert to kilograms
...
plot(pca.phylo, pch=22, phylo = TRUE, bg = gps2,
 ...
 legend(-3.75, 2.25, bty = "n", cex = .75, pt.cex = 1, x.intersp = 0.5, y.intersp = 1, fill = c("green",  "brown", "blue", "black", "purple"), legend = levels(as.factor(gps)))
